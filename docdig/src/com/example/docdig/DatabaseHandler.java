...
public class DatabaseHandler extends SQLiteOpenHelper{
	    ...
	    //Get single doctor
	    public Doctor getOneContact(String name) {	        	        
	        SQLiteDatabase db = this.getWritableDatabase();	        
	    ...
	    public List<String> getNamesList() {	        
	        ...
	        {	        	
		        while (cursor != null)
		        { 	        			        	
		        	if(!nameList.contains(cursor.getString(0)))
		        	{
	    ...
	    public List<String> getHospitalList() {	        
	        ...
	        if(cursor.moveToFirst())
	        {
		        ...
		        while (cursor != null)
		        { 	        	
		        	if(!hospitalList.contains(cursor.getString(6)))
		        	{
		        		hospitalList.add(cursor.getString(6));           	               		          	                		             
		        	}
		        	   if(cursor.isLast())
		                	break;
		                if(!cursor.moveToNext())
	    ...
	    public List<Doctor> getAllContacts(String jobs,String gend) {
	        ...
	        {
	        	selectQuery= "SELECT  * "+  "FROM " + TABLE_CONTACTS + " where " + KEY_JOB + 
	        		" = '" + jobs + "' and " + KEY_GENDER + " IN " + genders+"";
	        }
	        Cursor cursor = db.rawQuery(selectQuery, null);	        
	    ...
	    //for getting doctor list
	    public List<Doctor> getAllContacts(String jobs,String gend,String hospital) {
	        String genders;
	    	List<Doctor> doctorList = new ArrayList<Doctor>();
	        if(gend.equals("male"))
	        	genders="('male')";
	        ...
	        SQLiteDatabase db = this.getWritableDatabase();
	         String selectQuery="";
	        //Toast.makeText(this, jobs+" "+ hospital , Toast.LENGTH_SHORT).show();
	        boolean jobSelect=jobs.equals("All");
	        boolean hospSelect=hospital.equals("All");
	        if(jobSelect==true && hospSelect==true)
	        {
	        	selectQuery= "SELECT  * "+  "FROM " + TABLE_CONTACTS + " where " 
	        			+ KEY_GENDER + " IN " + genders+" ";
	        }
	        else if(jobSelect==true && hospSelect==false)
	        {
	        	selectQuery= "SELECT  * "+  "FROM " + TABLE_CONTACTS + " where " 
	        			+ KEY_GENDER + " IN " + genders+" and " 
	        			+ KEY_HOSP + " = '" + hospital +"' " ;
	        }
	        else if(jobSelect==false && hospSelect==true)
	        {
	        	selectQuery= "SELECT  * "+  "FROM " + TABLE_CONTACTS + " where " + KEY_JOB + 
		        		" = '" + jobs + "' and " + KEY_GENDER + " IN " + genders+" ";
	        }
